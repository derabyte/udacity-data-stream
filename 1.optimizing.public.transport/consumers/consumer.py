...
class KafkaConsumer:
    ...
    def __init__(
        ...
        # Configure the broker properties using the Host URL for Kafka and Schema Registry!
        ...
        # Configuring AvroConsumer to subscribe to topics. Making sure to think about
        # how the `on_assign` callback will be invoked.
    ...
    def on_assign(self, consumer, partitions):
        ...
        logger.info("STATUS: Topic partition assignment ")
        if self.offset_earliest:
            for partition in partitions:
                partition.offset = OFFSET_BEGINNING

        logger.info("SUCCESS: Partitions assigned for %s", self.topic_name_pattern)
    ...
    def _consume(self):
        ...
        while True:
            ...
            if message is None:
                logger.warning("WARNING: No message received")
                return 0
