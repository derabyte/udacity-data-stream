...
# available select against a view is different from a dataframe, and it makes it easy to select the nth element of an
...
# TO-DO: JSON parsing will set non-existent fields to null, so let's select just the fields we want, where they are not
# null as a new dataframe called emailAndBirthDayStreamingDF
